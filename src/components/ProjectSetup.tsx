...
export function ProjectSetup({ onProjectCreated }: ProjectSetupProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-900 to-indigo-950 flex items-center justify-center p-8">
        ...
        <div className="bg-gray-800/50 backdrop-blur-md border border-gray-700 rounded-3xl p-8 shadow-2xl shadow-purple-500/10">
          <div className="space-y-6">
            ...
            <Button
              ...
              className="w-full h-14 text-lg bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white shadow-lg shadow-blue-900/30"
            >
              Start Project
            </Button>
          </div>
